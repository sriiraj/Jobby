...
- Fetch the Data using public api's
- Async/Await to fetch Data
- Valid Login credentials using JWT Token
- link pages using react-router-dom npm packages
- Filter criteria to sort/search the Dynamic Data fetching from the public api's
- Handled Success ,failure,processing scenario's
- applied media queries for responsive
...
<div style="text-align: center;">
  <img src='https://assets.ccbp.in/frontend/content/react-js/jobby-app-home-lg-output.png' style='width:75%' alt="Home Page"/>
</div>
<br/>
...
<div style="text-align: center;">
  <img src='https://assets.ccbp.in/frontend/content/react-js/jobby-app-not-found-lg-output.png' style='width:75%' alt="Home Page"/>
</div>
<br/>
